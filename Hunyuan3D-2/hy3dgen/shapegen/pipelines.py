...
class Hunyuan3DDiTPipeline:
    ...
    def __call__(
        ...
        **kwargs,
        ...
        # Use flow-matching sigmas (0→1) when no explicit timesteps/sigmas given
        ...
        with synchronize_timer('Diffusion Sampling'):
            for i, t in enumerate(tqdm(timesteps, disable=not enable_pbar, desc="Diffusion Sampling:", leave=False)):
                ...
                # predict the noise residual — normalise t for flow-matching
                timestep_tensor = t.expand(latent_model_input.shape[0]).to(
